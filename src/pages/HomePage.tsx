      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        <div id="specialized" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* E-Commerce Card */}
              <Link to="/ecommerce" className="group relative bg-gradient-to-br from-blue-900/40 to-indigo-900/40 backdrop-blur-sm p-8 rounded-2xl border border-blue-400/30 hover:border-blue-400/60 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/30">
              ...
              {/* Cloud Kitchen Card */}
              <Link to="/cloud-kitchen" className="group relative bg-gradient-to-br from-orange-900/40 to-red-900/40 backdrop-blur-sm p-8 rounded-2xl border border-orange-400/30 hover:border-orange-400/60 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/30">
        ...
        <div id="resources" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/30">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Link to="/rates" className="group bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm p-8 rounded-xl border border-cyan-400/20 hover:border-cyan-400/50 transition-all duration-300 transform hover:scale-105">
                <div className="flex items-start space-x-6">
              ...
              <Link to="/driver-app" className="group bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm p-8 rounded-xl border border-cyan-400/20 hover:border-cyan-400/50 transition-all duration-300 transform hover:scale-105">
                <div className="flex items-start space-x-6">
                  <div className="bg-gradient-to-r from-cyan-500 to-blue-500 p-4 rounded-lg">
